...
public class CookingTab extends Fragment implements AsyncResponse {
    ...
    public static CookingTab newInstance() {
        //this line creates the fragment
        CookingTab fragment = new CookingTab();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cooking_tab, container, false);
        ...
        task.execute("http://10.0.2.2/CookingOrders.php");
        long endTime = System.nanoTime();
        long duration = (endTime - startTime)/1000000;
        Log.d("time", "Requesting tables took: " + duration + " milliseconds");
    ...
    public void processFinish(String s) {
        ...
        CookingList = (ListView)getActivity().findViewById(R.id.cookingList);
