...
public class ReadyTab extends Fragment implements AsyncResponse {
    ...
    public static ReadyTab newInstance() {
        //this line creates the fragment
        ReadyTab fragment = new ReadyTab();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_ready_tab, container, false);
        ...
        task.execute("http://10.0.2.2/ReadyOrders.php");
    ...
    public void processFinish(String s) {
        ...
        CookingList = (ListView)getActivity().findViewById(R.id.readyList);
